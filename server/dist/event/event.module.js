...
let EventModule = class EventModule {
    configure(consumer) {
        consumer.apply(auth_middlware_1.SiteManagerMiddleware).forRoutes({ path: 'api/events/*', method: common_1.RequestMethod.DELETE });
        consumer.apply(auth_middlware_1.SiteManagerMiddleware).forRoutes({ path: 'api/events', method: common_1.RequestMethod.PATCH });
...
EventModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Event', schema: event_model_1.EventScheme }, { name: 'Schedule', schema: schedule_model_1.ScheduleScheme }, { name: 'User', schema: user_model_1.UserScheme }])],
