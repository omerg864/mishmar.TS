    ...
    <main>
        ...
        <Card sx={{ width: '60%', overflow: 'visible' }}>
          <CardContent sx={{textAlign: 'center', position: 'relative'}}>
            ...
            <TextField value={settings.pin_code} required onChange={handleChange} name="pin_code" color="primary" label="Pin Code" />
            <div style={{marginTop: '10px'}}>
              <TextField value={settings.officer} onChange={handleChange} name="officer" label="Officer" />
            </div>
            <div style={{marginTop: '10px'}}>
              <TextField value={settings.title} required onChange={handleChange} name="title" color="primary" label="Title" />
            </div>
            <div style={{marginTop: '10px'}}>
