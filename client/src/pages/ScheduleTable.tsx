    ...
    const getData = async () => {
        ...
        try {
            ...
            if (data.error || data.statusCode) {
                fetch('/api/logs', {method: 'POST', body: JSON.stringify({user: cookies.get('user'), err: data, path: `schedules/table/${id}`, component: "ScheduleTable" })})
            ...
            fetch('/api/logs', {method: 'POST', body: JSON.stringify({user: cookies.get('user'), err, path: `schedules/table/${id}`, component: "ScheduleTable" })})
